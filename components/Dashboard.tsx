...
export const Dashboard: React.FC = () => {
  ...
  const { chartData, categoryData } = useMemo(() => {
    ...
    // We want to calculate the Average Completion Rate (Coeff) per Category
    // Logic: Sum of coefficients (Done=1, Neutral=0.25, NotDone=0) divided by number of tasks in that category
